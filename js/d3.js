!(function () {
  ...
  function Lt() {
    var n = Tt(),
      t = qt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(Wa), (Wa = setTimeout(Lt, t))), (Ja = 0))
      : ((Ja = 1), Ka(Lt));
  }
  function Tt() {
    var n = Date.now();
      ...
      function t(t) {
        for (var r, u, i, o = [], a = -1, c = 0; ++a < e; )
          37 === n.charCodeAt(a) &&
            ...
            null != (u = ic[(r = n.charAt(++a))]) && (r = n.charAt(++a)),
            (i = C[r]) && (r = i(t, null == u ? ("e" === r ? " " : "0") : u)),
            o.push(r),
            (c = a + 1));
      ...
      var g,
        ...
        y = {
          ...
          polygonEnd: function () {
            ...
            var n = Dr(m, p);
            g.length
              ? (_ || (i.polygonStart(), (_ = !0)), Cr(g, Rr, n, r, i))
              : n &&
      ...
      if (l)
        for (
          ...
          var m = n[0],
            ...
            k = p * x;
          if (
            (gc.add(Math.atan2(k * b * Math.sin(w), v * M + k * Math.cos(w))),
            (i += S ? _ + b * Ea : _),
            S ^ (h >= r) ^ (m >= r))
          ) {
            var E = dr(pr(f), pr(n));
      ...
      var v,
        ...
        N = {
          ...
          polygonEnd: function () {
            ...
            (r || u) &&
              (a.polygonStart(),
              r && (a.lineStart(), s(null, null, 1, a), a.lineEnd()),
              u && Cr(v, i, t, s, a),
              a.polygonEnd()),
              (v = d = m = null);
          },
  ...
  function $e(n) {
    var t = n.circle;
    t &&
      (t.P || (Jc = t.N), Wc.remove(t), Kc.push(t), tu(t), (n.circle = null));
  }
  function Xe(n) {
    for (
      var t, r = $c, e = Fr(n[0][0], n[0][1], n[1][0], n[1][1]), u = r.length;
      u--;
  ...
  function Hu(n, t) {
    ...
    return (
      ...
      f != h
        ? u.push({ i: e.push(e.pop() + "skewX(", null, ")") - 2, x: pu(f, h) })
    ...
    if ((r = n.children) && (s = r.length)) {
      ...
      if (
        ...
        for (
          ...
          p
            ? (d > v || (v == d && u.r < e.r) ? di(e, (u = a)) : di((e = c), u),
              o--)
            : (vi(e, i), (u = i), t(i));
        }
      var m = (l + f) / 2,
  ...
  function Wi(n, t, r) {
    ...
    return (
      ...
      (e.exponent = function (o) {
        return arguments.length
          ? ((u = Gi((t = o))), (i = Gi(1 / t)), n.domain(r.map(u)), e)
          : t;
      }),
      (e.copy = function () {
  ...
  function ao(n) {
    function t(t) {
      ...
      for (
        var c, s = [], l = [], f = -1, h = t.length, g = Et(r), p = Et(e);
        ++f < h;
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = bs.get(n) || co).key),
            t)
          : o;
      }),
  ...
  function po(n, t) {
    return n.length < 3
      ? co(n)
      : n[0] +
          mo((n.push(n[0]), n), yo([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function vo(n, t) {
  ...
  function zo(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = bs.get(n) || co).key),
            (s = a.reverse || a),
            (l = a.closed ? "M" : "L"),
            t)
          : c;
    ...
    (ya.selectAll = function (n) {
      ...
      for (var u = -1, i = this.length; ++u < i; )
        for (var o = this[u], a = -1, c = o.length; ++a < c; )
          (r = o[a]) &&
            (e.push((t = Wo(n.call(r, r.__data__, a, u)))), (t.parentNode = r));
      return _(e);
    });
  var xa = {
    ...
    (Ma.select = function (n) {
      for (var t, r, e, u, i, o = [], a = -1, c = this.length; ++a < c; ) {
        ...
        for (var s = -1, l = u.length; ++s < l; )
          (i = u[s])
            ? (t.push((e[s] = r = n.call(u.parentNode, i.__data__, s, a))),
    ...
    (ya.transition = function () {
      for (
        var n,
          ...
          r = As || ++Ts,
          e = [],
          u = Cs || { time: Date.now(), ease: wu, delay: 0, duration: 250 },
          i = -1,
          o = this.length;
        ++i < o;
      ...
      function t(n, t, u, i, o) {
        return function () {
          ...
          var s,
            ...
            x = t(h, v);
          e
            ? ((s = e.apply(l, arguments)), (s = [s.x - x[0], s.y - x[1]]))
            : (s = [0, 0]),
            g({ type: "dragstart" });
        };
      }
      ...
      function l() {
        ...
        function f() {
          if (Bo.event.touches.length) {
            for (
              var t = Bo.event.changedTouches, r = 0, e = t.length;
              e > r;
              ++r
            )
      ...
      function g() {
        ...
        o(n),
          e(
            Math.pow(
              2,
              Bo.event.shiftKey ? Math.ceil(s) - 1 : Math.floor(s) + 1
            )
          ),
          u(r, i),
          a(n),
    ...
    (Bo.dsv = function (n, t) {
      ...
      return (
        ...
        (r.parseRows = function (n, t) {
          ...
          for (
            var e, u, i = {}, o = {}, a = [], s = n.length, l = 0, f = 0;
            (e = r()) !== o;
  ...
  (rc.year = Ht(
    ...
    [
      ...
      var r = (rc[n] = Ht(
        function (n) {
          return (
            (n = rc.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function (n, t) {
  ...
  (Bo.geo.path = function () {
    ...
    (Bo.geo.rotation = function (n) {
      ...
      return (
        ...
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * za, t[1] * za)), (t[0] *= La), (t[1] *= La), t
          );
        }),
        t
      );
        ...
        if (
          ...
          do {
            ...
            if (n === u.L) {
              ...
              ((t = u.L),
              t.C && ((t.C = !1), (u.C = !0), eu(this, u), (t = u.L)),
              (t.L && t.L.C) || (t.R && t.R.C))
            ) {
              (t.L && t.L.C) ||
    ...
    (Bo.layout.chord = function () {
      function n() {
        ...
        for (
          ...
          (e[y] = { index: y, startAngle: f, endAngle: s, value: (s - f) / n }),
            (s += l);
        }
        for (h = -1; ++h < i; )
          for (g = h - 1; ++g < i; ) {
      ...
      if (g > 0)
        for (i = -1; ++i < h; )
          (a = s[i]),
            a >= l[0] &&
              a <= l[1] &&
              ((o = c[Bo.bisect(f, a, 1, g) - 1]), (o.y += p), o.push(n[i]));
      return c;
    }
    var t = !0,
      r = Number,
  ...
  (Ls.call = ya.call),
    ...
    (Ls.transition = function () {
      for (
        var n, t, r, e, u = this.id, i = ++Ts, o = [], a = 0, c = this.length;
        c > a;
        a++
      ) {
        o.push((n = []));
    ...
    function n(i) {
      i.each(function () {
        ...
        c && ((l = Pi(c)), h.attr("x", l[0]).attr("width", l[1] - l[0]), r(f)),
          s &&
            ((l = Pi(s)), h.attr("y", l[0]).attr("height", l[1] - l[0]), e(f)),
          t(f);
      });
    }
    function t(n) {
